    ...
    <div className="bg-background-2 px-[10px] pt-[18px] pb-[23px] rounded-lg flex flex-col sm:hidden">
      ...
      <div className="flex justify-between mt-8">
        ...
        <div className="flex gap-[8px]">
          <button className="py-[6px] px-[13.5px] w-[96px] max-h-[28px] flex justify-center items-center bg-primary-blue text-white rounded-[17px] typo-heading-4">
            <IntlMessages id="common.deactivate" />
          </button>
          <button className="py-[6px] px-[13.5px] w-[96px] max-h-[28px] flex justify-center items-center border border-primary-blue text-primary-blue rounded-[17px] typo-heading-4">

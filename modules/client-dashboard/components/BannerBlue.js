export default function BannerBlue() {
  return (
    <div className="grid-main gap-x-3 col-span-full bg-background-2 py-[16px] h-[110px] mt-[10px] sm:mt-[32px] sm:rounded-2xl sm:min-h-[106px] md:flex md:items-center md:justify-center md:gap-[38px] md:py-4 md:h-auto md:min-h-0">

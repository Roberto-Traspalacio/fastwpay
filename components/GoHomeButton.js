...
export default function GoHomeButton({ className = '', children }) {
  return (
    <Link href='/'>
      <button className={`${className} flex items-center gap-[14px] xsm:gap-[18px] esm:mt-[18px] cursor-pointer mt-[14px] sm:mt-[24px] sm:gap-[24px] lg:gap-[20px] lg:ml-[40px] xl:gap-[24px]`}>

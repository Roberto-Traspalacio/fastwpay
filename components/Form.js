...
export default function Form({ children }) {
  return (
    <form className="grid-main bg-background-2 pt-14 gap-x-3 full-bleed-section lg:pb-20 ">
      ...
      <label
        htmlFor="name"
        className="mb-2 label-name typo-body-2 sm:col-start-2 col-span-full xl:col-start-7 text-text-1 lg:col-start-3 lg:col-span-4"
      >
      ...
      <label
        htmlFor="email"
        className="mb-2 label-email typo-body-2 sm:col-start-2 col-span-full xl:col-start-7 text-text-1 lg:col-start-3 lg:col-span-4"
      >
      ...
      <label
        htmlFor="message"
        className="mb-2 label-message typo-body-2 sm:col-start-2 col-span-full xl:col-start-7 text-text-1 lg:col-start-3 lg:col-span-4"
      >

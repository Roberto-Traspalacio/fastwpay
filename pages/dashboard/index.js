              ...
              <div className="flex flex-col-reverse md:grid-main px-[18px] pt-9 col-span-full sm:pt-12 md:px-0 lg:pt-8">
                ...
                <div className="md:col-span-full lg:col-span-3 xl:col-span-7 lg:pb-6">
                  ...
                  <p className="mt-3 typo-body-1 text-text-4 pb-6">
                    ...
                    pharetra nisl sit sed. Arcu dictum nisl pretium at dictum ultricies. Aliquet eu elementum lacus
                    sapien nunc pharetra facilisis diam eu. Tortor adipiscing fermentum sed duis. Adipiscing quis
                    ultrices tempus tristique sit urna. Erat nisi tellus diam at viverra velit augue tempus rutrum. Sed
                    accumsan sit ac amet lectus libero.
                  </p>
                </div>
                <BalanceCard />
              </div>

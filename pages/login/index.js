...
export default function Login() {
  ...
  const inputStyles =
    'input-name bg-background-2 h-9 col-span-full rounded-md sm:rounded-[10px] mb-[18px] sm:mb-5 sm:h-12 py-4 px-5 typo-body-1 sm:col-span-6 sm:col-start-2 xl:col-start-3 xl:col-span-8 lg:col-start-3 lg:col-span-4';
        ...
        <div className="flex flex-col xl:w-[50%] xl:relative overflow-auto scrollbar">
          ...
          <div className="pt-20 sm:pt-[132px] md:pt-[155px] lg:pt-[51px] xl:absolute xl:right-0 xl:left-0 xl:top-[50%] xl:translate-y-[-50%] xl:pt-0">
            <form className="grid-main gap-x-3">
              <h2 className="text-center typo-heading-1 col-span-full mb-6 esm:mb-8 sm:mb-10" style={{ color: '#202324' }}>
                Login
              </h2>
